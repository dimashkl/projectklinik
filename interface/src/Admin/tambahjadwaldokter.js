...
const TambahJadwalDokter = () => {
    ...
    return (
        ...
        <div className="cfBG">
            <Container>
                <div className="column is-centered" style={{marginTop:"60px"}}>
                <h2 className="title">Input Informasi dan Jadwal Dokter</h2>
                <br/>
                <br/>
                    <div className="column">
                        <div style={{marginTop:"-20px"}} className="column is-half">
                        <div className="field">
                        ...
                        <footer className="border shadow-lg rounded" style={{position:"fixed", padding:"40px 496px", bottom:"30px", background:"white"}}>
...
export default TambahJadwalDokter